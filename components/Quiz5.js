...
export default function Login({navigation}) {
  return (
    <View style={styles.container}>
      ...
      <Text style={{ fontSize: 25, marginTop: 10, marginLeft: 5, fontWeight: 'bold', color: 'white', }}>5</Text>
      </View>
      <View style={styles.card}>
      <View style={{flexDirection:'row'}}>
      <Text style={{ fontSize: 15, marginTop: 15, fontWeight: 'bold', color: 'black', marginLeft: 20, }}>We clean the house … we prevent the bacteria coming.</Text>
      </View>
      <TouchableOpacity onPress={() => navigation.navigate('Alert')}>
      <View style={styles.card1}>      
      <Text style={{ fontSize: 15, marginTop: 25, marginLeft: 117, fontWeight: 'bold' }}>Will</Text>
      </View>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate('Alert')}>
      <View style={styles.card1}>      
      <Text style={{ fontSize: 15, marginTop: 25, marginLeft: 115, fontWeight: 'bold' }}>Need</Text>
      </View>
      </TouchableOpacity>
