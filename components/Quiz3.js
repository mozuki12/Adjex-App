...
export default function Login({navigation}) {
  return (
    <View style={styles.container}>
      ...
      <Text style={{ fontSize: 25, marginTop: 10, marginLeft: 5, fontWeight: 'bold', color: 'white', }}>3</Text>
      </View>
      <View style={styles.card}>
      <View style={{flexDirection:'row'}}>
      <Text style={{ fontSize: 15, marginTop: 15, fontWeight: 'bold', color: 'black', marginLeft: 20, }}>Do you bring the novel ... I gave it to you yesterday?</Text>

      </View>
      <TouchableOpacity onPress={() => navigation.navigate('Alert')}>
      <View style={styles.card1}>      
      <Text style={{ fontSize: 15, marginTop: 25, marginLeft: 120, fontWeight: 'bold' }}>How</Text>
      </View>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate('Alert')}>
      <View style={styles.card1}>      
      <Text style={{ fontSize: 15, marginTop: 25, marginLeft: 120, fontWeight: 'bold' }}>That</Text>
      </View>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate('Quiz4')}>
      <View style={styles.card1}>
      <Text style={{ fontSize: 15, marginTop: 25, marginLeft: 115, fontWeight: 'bold' }}>Which</Text>
      </View>
      </TouchableOpacity>
      </View>
