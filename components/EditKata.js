...
export default function Login({navigation}) {
  return (
    <View style={styles.container}>
      ...
      <Text style={{fontSize: 17, marginLeft: 70, color: 'white', fontWeight: 'bold',}}> EDIT KATA </Text>
      </View>
      <View style={styles.card}>
      <Text style={{fontSize: 15, marginLeft: 20, marginTop: 30, fontWeight: 'bold'}}>KATA :</Text>
      ...
      <Text style={{fontSize: 13, marginLeft: 21, marginTop: 30, fontWeight: 'bold'}}>DESKRIPSI KATA :</Text>
      <TextInput
        style={{marginTop: 10, marginLeft: 20, borderColor: '#ccc', borderWidth: 1,borderRadius: 10, fontSize: 13, height: 130, width: 260, backgroundColor: 'none', padding: 10,}}
        placeholder="Ketik disini secara detail"
        multiline={true}
        numberOfLines={4}
      />
      <Text style={{fontSize: 15, marginLeft: 20, marginTop: 20, fontWeight: 'bold'}}>EXAMPLE :</Text>
      <TextInput
        style={{marginTop: 20, marginLeft: 20, borderColor: '#ccc', borderWidth: 1,borderRadius: 10, fontSize: 13, height: 70, width: 260, backgroundColor: 'none', padding: 10,}}
        placeholder="Ketik disini secara detail"
        multiline={true}
        numberOfLines={4}
      />
      <TouchableOpacity style={{marginTop: 30, marginLeft: 220,}} onPress={() => navigation.navigate('')}>
