...
export default function Login({navigation}) {
  return (
    <View style={styles.container}>
      ...
      <Text style={{ fontSize: 25, marginTop: 10, marginLeft: 5, fontWeight: 'bold', color: 'white', }}>4</Text>
      </View>
      <View style={styles.card}>
      <View style={{flexDirection:'row'}}>
      <Text style={{ fontSize: 15, marginTop: 15, fontWeight: 'bold', color: 'black', marginLeft: 18, }}>I promise I will study hard ….graduate soon.</Text>
      </View>
      <TouchableOpacity onPress={() => navigation.navigate('Alert')}>
      <View style={styles.card1}>      
      <Text style={{ fontSize: 15, marginTop: 25, marginLeft: 110, fontWeight: 'bold' }}>So that</Text>
      </View>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate('Alert')}>
      <View style={styles.card1}>      
      <Text style={{ fontSize: 15, marginTop: 25, marginLeft: 100, fontWeight: 'bold' }}>In spite of</Text>
      </View>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate('Quiz5')}>
      <View style={styles.card1}>
      <Text style={{ fontSize: 15, marginTop: 25, marginLeft: 100, fontWeight: 'bold' }}>In order to</Text>
      </View>
      </TouchableOpacity>
      </View>
